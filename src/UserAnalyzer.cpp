...
Proofpoint::UserAnalyzer::UserAnalyzer(const UserSafeList& userlist, PatternErrors& pattern_errors)
{
...
void Proofpoint::UserAnalyzer::Process(const std::string& ss_file, UserSafeList& userlist)
{
	std::size_t count = 0;
	...
	csv::HeaderList required_headers{"Policy_Route","Header_From","Sender"};
